...
`cases.json` contains 11 English administrative scenarios. Every institution, form, portal, appointment, account, and date is fictional. The corpus contains no personal data. It covers university, tenancy, medical appointments, HR, government, and billing, including:

- no-action notices and negative commands;
- completed-submission confirmations whose optional receipt controls must not become tasks;
...
- hallucinated, ungrounded, and merely optional action;
- wrong calendar date;
- wrong reply channel;
...
The default runs all 11 cases. An intentional smoke run can select or limit cases:
