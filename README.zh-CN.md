...
| 你的 Mac | 下载 |
| --- | --- |
| Apple 芯片——M1、M2、M3、M4 及更新型号 | [下载 Slipstream 1.0.4 arm64 版](https://github.com/0boluan0/Slipstream/releases/download/v1.0.4/Slipstream-1.0.4-arm64.dmg) |
| Intel 处理器 | [下载 Slipstream 1.0.4 x64 版](https://github.com/0boluan0/Slipstream/releases/download/v1.0.4/Slipstream-1.0.4-x64.dmg) |
