# Action workspace compatibility contract

This document preserves the action-workspace contract for existing results, recovery flows, provider compatibility checks, and regression fixtures. The current product direction and default entry behavior are specified in [SPEC.md](../SPEC.md).
